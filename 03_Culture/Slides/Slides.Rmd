...
- Clustering based on clutural history
...
- Coping only applies to features with different traits
- If they only differ in one, the active agent copies that one
- Model converges if all similarities are zero or one
...
- More features, less cultures
- More traits per feature, more cultures
...
- Axelrod's culture model
  ...
  - Grid size fosters culture homogeneity
